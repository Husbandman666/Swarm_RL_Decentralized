## This code is for testing the model trained by reinforce-agent_edit2.py
##
import copy
import pylab
import numpy as np
from environment_edit_2 import Env
...
if __name__ == "__main__":
    ...
    agent.model.load_weights('./save_model/reinforce.h5')
    ...
    while not done:
        ...
        if done:
            ...
            next_state, reward, done = env.step(action)
            state = copy.deepcopy(next_state)
            print("episode:", 1, "  score:", score, "  time_step:",
                      global_step)
            break
