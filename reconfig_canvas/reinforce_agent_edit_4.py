...
if __name__ == "__main__":
    ...
    for e in range(EPISODES):
        ...
        while 1:
            ...
            #print(reward)
            agent1.append_sample(state1, action1, reward[0] + reward[1])
            agent2.append_sample(state2, action2, reward[0] + reward[1])
            score += reward[0]
            score2 += reward[1]
        ...
        if e % 100 == 0:
            ...
            agent1.model.save_weights("./save_model/agent1_new2.h5")
